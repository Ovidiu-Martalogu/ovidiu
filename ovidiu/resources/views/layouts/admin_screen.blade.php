...
<html lang="{{ app()->getLocale() }}">
    ...
    <div class="container-fluid"> <!-- according to the bootstrap frontend framework, all the code should be encapsulated in a div with .container or .container-fluid class -->
        @yield('content')
    </div>
